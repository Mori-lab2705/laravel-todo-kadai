...
@section('content')
    <div class="container h-100"> 
        ...
        <div class="row row-cols-1 row row-cols-md-2 row-md-2 row-cols-lg-3 g-4">
            ...
            <div class="col">     
                <div class="card bg-light">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">    
                            <a href="#" class="px-2 fs-5 fw-5 fw-bold link-dark text-decoration-none" data-bs-toggle="modal" data-bs-target="#addTodoModal{{ $goal->id }}">+</a>                                                     
                            <div class="dropdown">
